...
//鎸塱d鑾峰彇瀵硅薄  
Showbo.$ = function(Id, isFrame) { var o; if ("string" == typeof(Id)) o = document.getElementById(Id);
        else if ("object" == typeof(Id)) o = Id;
        else return null; return isFrame ? (Showbo.IsIE ? frames[Id] : o.contentWindow) : o; }
    //鎸夋爣绛惧悕绉拌幏鍙栧璞�  
    //椤甸潰鐨勯珮鍜屽******************************  
...
Showbo.initBodyScale = function() { Showbo.BodyScale.x = Showbo.getWidth(false);
...
Showbo.Msg = {
    ...
    InitMsg: function(width) {
        ...
        if (Showbo.IsIE && Showbo.IEVersion < 7) { //鍔爄frame灞備慨姝e6涓嬫棤娉曢伄鐩栦綇select鐨勯殣鎮�  
    ...
    createBtn: function(p, v, fn) {
        ...
        if (v == '纭') {
            ...
            btn.id = 'qd';
            btn.addEventListener("click", function() { OnDivClick(); }, false);
    ...
    confirm: function(msg, fn) {
        ...
        this.show({ buttons: { yes: '纭', no: '鍙栨秷' }, msg: msg, title: '鎻愮ず', fn: fn });
    },
    ...
    show: function(cfg) {
        ...
        if (cfg.wait) {
            ...
            if (cfg.buttons.yes) {
                ...
                if (cfg.buttons.no) this.dvBtns.appendChild(document.createTextNode('銆€'));
            }
